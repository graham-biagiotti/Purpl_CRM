...
function importNEMShowAccounts() {
  ...
  const RECORDS = [
    {name:"Osbornes",contact:'Gretchen Wolfe',phone:'603-228-8561',email:'gretchen@osbornesfarm.com',address:'258 Sheep Davis Road, Concord, NH',type:'Farm / Country Store',dropOffRules:'',note:'NEM show order.'},
    {name:'Poland Provisions',contact:'Sheila Foley',phone:'207-402-7123',email:'info@polandprovisions.com',address:'1220 Maine St., Poland, ME',type:'Specialty / Gift',dropOffRules:'',note:'NEM show order.'},
    {name:'New England Mercantile',contact:'Kyle Eldridge',phone:'603-772-0263',email:'keldridge.nemercantile@gmail.com',address:'Water St., Exeter, NH',type:'Specialty / Gift',dropOffRules:'',note:'Cash and carry. NEM show order.'},
    {name:'Wild Oats Bakery and Cafe',contact:'Colleen Gilliatt',phone:'207-725-6287',email:'market@wildoatsbakery.com',address:'166 Admiral Fitch Avenue, Brunswick, ME',type:'Café',dropOffRules:'',note:'NEM show order.'},
    {name:'Douglas Brook Farm',contact:'Kim Bragdon',phone:'207-659-9581',email:'douglasbrookfarm@gmail.com',address:'21 Files Rd, Gorham, ME',type:'Farm / Country Store',dropOffRules:'Mid April invoice.',note:'NEM show order. Mid April invoice.'},
    {name:'New Morning Natural Foods',contact:'Ariel Peacock',phone:'207-985-6774',email:'ariel@newmorningme.com',address:'3 York Street, Kennebunk, ME',type:'Specialty / Gift',dropOffRules:'',note:'NEM show order.'},
    {name:'Harpswell Collective',contact:'Liz Negler',phone:'617-653-6960',email:'liz@harpswellcollective.com',address:'1906 Harpswell Neck Rd, Harpswell, ME',type:'Specialty / Gift',dropOffRules:'Late May invoice.',note:'NEM show order. Late May invoice.'},
    {name:'Portsmouth Soap Co',contact:'Lauren',phone:'207-451-7904',email:'lauren@portsmouthsoaps.com',address:'175 Market St., Portsmouth, NH',type:'Specialty / Gift',dropOffRules:'',note:'NEM show order.'},
    {name:'Enfield Shaker Museum',contact:'Carolyn Smith (Acting Director)',phone:'603-632-4346',email:'director@sharkermuseum.org',address:'477 NH Route 4A, Enfield, NH',type:'Specialty / Gift',dropOffRules:'',note:"Mothers Day? NEM show order."},
    {name:"Singleton's Store",contact:'Allison and Danielle Singleton',phone:'802-226-7666',email:'store@singletonvt.com',address:'356 Main St, Proctorsville, VT',type:'Specialty / Gift',dropOffRules:'',note:'NEM show order.'},
    {name:'Maine Homestead Market',contact:'',phone:'207-499-4292',email:'mainehomsteadstore@gmail.com',address:'1773 Alfred Rd, Lyman, ME',type:'Farm / Country Store',dropOffRules:'',note:'NEM show order.'},
    {name:'Beachside Variety',contact:'Sheila Gillian',phone:'207-450-0753',email:'',address:'124 W Grand Ave, Old Orchard Beach, ME',type:'Specialty / Gift',dropOffRules:'CASH ON DELIVERY. Mid May. Text when close, notify before delivery.',note:'NEM show order. Cash on delivery, mid May. Text when close, notify before delivery.'},
    {name:'Wild Goose Country Store',contact:'Sharon Parsons',phone:'',email:'wildgoosecountrystore@hotmail.com',address:'77 Main St, Sunapee, NH 03782',type:'Farm / Country Store',dropOffRules:'CC on order form. Ship to 511 North Road, Sunapee NH. Mid May.',note:'NEM show order. CC info on order form, ship to 511 North Road Sunapee NH. Mid May. Was signed up for wholesale already.'},
    {name:'The Seagull Shop',contact:'Brooke Cotter (Partner/GM)',phone:'207-677-2374',email:'seagullbrooke@gmail.com',address:'3119 Bristol Rd, New Harbor, ME',type:'Specialty / Gift',dropOffRules:'May invoice.',note:'NEM show order. May invoice.'},
    {name:'Original General Store',contact:'Lauren Foley',phone:'802-746-8888',email:'ogs802@gmail.com',address:'3963 VT RT 100, Pittsfield, VT',type:'Specialty / Gift',dropOffRules:'',note:'NEM show order.'},
    {name:'Whimsical Wishes',contact:'Joanne Meeks / Richard Torrey',phone:'508-317-0659',email:'joannemeeks@msn.com',address:'170 Water St, Plymouth, MA',type:'Specialty / Gift',dropOffRules:'',note:'NEM show order.'},
    {name:'Love at First Light',contact:'Tammy Fairchild',phone:'207-213-5867',email:'loveatfirstlight@yahoo.com',address:'77 Water St, Lubec, ME',type:'Specialty / Gift',dropOffRules:'May invoice.',note:'NEM show order. May invoice.'},
    {name:'Nesting Dusk',contact:'Mary Thurlow and Ruth Brown',phone:'',email:'nestduck@aol.com',address:'17 Perkins Cove, Ogunquit, ME',type:'Specialty / Gift',dropOffRules:'',note:'NEM show order.'},
  ];
